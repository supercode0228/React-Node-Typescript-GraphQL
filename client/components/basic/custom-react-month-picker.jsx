...
export default class MonthPicker extends Component {
    static propTypes = {
        ...
        show: PropTypes.bool,
        allowPerpetual: PropTypes.bool,
        perpetualLabel: PropTypes.string,
    }
    static defaultProps = {
                ...
                <div className={["rmp-container", "rmp-table", this.props.className, (this.state.showed ? "show" : '')].join(' ')}>
                    ...
                    <div className="rmp-cell">
                        <div className={["rmp-popup", popupClass , this.props.theme, (this.state.showed ? "show" : '')].join(' ')}>
                            {this.props.allowPerpetual &&
                            <>
                                <Checkbox
                                    checked={this.props.value.perpetual} 
                                    onChange={val => val 
                                        ? this.props.onChange(0, 0, 0, true, false) 
                                        : this.props.onChange(this.props.value.year, this.props.value.month, 0, false, false)
                                    }
                                    label={this.props.perpetualLabel}
                                />
                            </>
                            }
                            {!this.props.value.perpetual && pads}
                        </div>
                    </div>
                </div>
            </div>
